...
SET IDENTITY_INSERT ACCOUNT_USER ON;
...
SET IDENTITY_INSERT ACCOUNT_USER OFF;
GO
...
INSERT [dbo].[READER] ([ID], [USER_NAME_TEXT], [DOB], [ADDRESS], [EMAIL], [DATECREATED], [READERTYPE]) VALUES (5, N'user4', CAST(N'1995-03-22T00:00:00.000' AS DateTime), N'321 Pine St, City', N'user4@example.com', CAST(N'2024-12-01' AS Date), N'Regular')
INSERT [dbo].[READER] ([ID], [USER_NAME_TEXT], [DOB], [ADDRESS], [EMAIL], [DATECREATED], [READERTYPE]) VALUES (6, N'1', CAST(N'1992-11-01T00:00:00.000' AS DateTime), N'1', N'1', CAST(N'2024-12-06' AS Date), N'hs')
